...
// query products
$stmt = $doenca->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$doenca->count();
    $page_url="{$home_url}doenca/read_paging.php?";
    $paging=$utilities->getPaging($page, $total_rows, $records_per_page, $page_url);
    $doencas_arr["paging"]=$paging;
