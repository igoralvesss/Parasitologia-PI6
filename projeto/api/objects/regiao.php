...
class Regiao{
    ...
    function read(){
        ...
        // select all query
        $query = " SELECT * FROM " . $this->table_name . " p, " . $this->table_name2 . " d,
                                 " . $this->table_name3 . " p, " . $this->table_name4 . " d,
                                 " . $this->table_name5 . " p
                    WHERE p.id_regiao = d.regiao_id
                      AND p.id_regiao = ?";
       /* $query = "SELECT
...
function readOne(){
    ...
    $stmt->bindParam(1, $this->id_regiao);
