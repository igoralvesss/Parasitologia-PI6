...
<body id="page-top">
    ...
    <div class="container px-5">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
          <li class="nav-item"><a class="nav-link me-lg-3" href="index.php">Principal</a></li>
        ...
        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="modal" data-bs-target="#feedbackModal">
          <span class="d-flex align-items-center">
            ...
            <span class="small"><a class="text-light" style="text-decoration: none;" href="jogo/index.html"> QUIZ <a></span>
          </span>
        </button>
      </div>
    </div>
  ...
  <header class="corzinha mt-5">
    <div class="container cont_principal d-flex justify-content-around mt-5">
      ...
      <div class="secundario2">
        <div class="mb-5 mt-5 mb-lg-0 text-center text-lg-start d-flex justify-content-center flex-wrap">
          <img class="logo_grande" src="assets/img/logo_grande.png" width="400px" alt="">
          <p class="text-center mb-2 fs-5">Acompanhe as doenças parasitarias que aparecem com frequência na sua região e tenha informações que podem te livrar de um possivel contágio.</p>
          <p class="text-center lead fw-normal text-muted mb-5 fs-6">Também temos nossa versão mobile, click na imagem a baixo que será direcionado ao instalador do aplicativo.</p>
          <div class="d-flex flex-column flex-wrap-nowrap flex-lg-row align-items-center ma-2">
            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge" src="assets/img/google-play-badge.svg" alt="..." /></a>
          </div>
        </div>
      </div>

      <div class="secundario1 d-flex justify-content-center pa-2">
        <svg class="pa-4 mt-2" version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="450px" height="460px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
          <g>
            <a xlink:href="regioes/norte.php?id_regiao=4" class="hrf-norte">
            ...
            <a xlink:href="regioes/nordeste.php?id_regiao=5" class="hrf-nordeste">
              <title>Bahia</title>
            ...
            </a><a xlink:href="regioes/norte.php?id_regiao=4" class="hrf-norte">
            ...
            <a xlink:href="regioes/centro_oeste.php?id_regiao=3" class="hrf-centro-oeste">
            ...
            <a xlink:href="regioes/sul.php?id_regiao=2" class="hrf-sul">
              <title>Paraná</title>
            ...
            <a xlink:href="regioes/sudeste.php?id_regiao=1" class="hrf-sudeste">
  ...
  <!-- Footer-->
  <footer class="bg-black text-center py-5 mt-1">
    <div class="container px-5">
