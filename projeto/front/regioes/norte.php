...
$json_url = "http://localhost/PI6/back/api/regiao/read_one.php?id_regiao=4";
    ...
    <header class="container mt-5">
        ...
        <div class="card  mb-5">
            <div class="card-header text-white bg-primary d-flex justify-content-between">
                ...
                <a href="../conteudos.php?id_doenca=5" class="btn btn-primary">Saiba mais</a>
            </div>
            <div class="card-body">
                ...
                <p class="card-text">
                    A ascaridíase é a doença causada por vermes parasitas mais disseminada no pelo mundo. A infecção acontece pela ingestão dos ovos do verme Ascaris Lumbricoide, e é popularmente conhecida como lombriga.</p>
            </div>
        </div>
        ...
        <div class="card  mb-5">
            <div class="card-header text-white bg-primary d-flex justify-content-between">
                <a class="btn btn-primary">Doença</a>
                <a href="../conteudos.php?id_doenca=11" class="btn btn-primary">Saiba mais</a>
            </div>
            <div class="card-body">
                <h5 class="card-title text-dark">
                    Peste bulbônica
