    ...
    <header class="corzinha mt-5">
        ...
        <nav class="mt-5 ms-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Transmissão</li>
            </ol>
        </nav>
        <div class="container cont_principal d-flex justify-content-around mt-5">
            <div class="row g-0 bg-light position-relative">
                ...
                <div class="col-md-6 p-4 ps-md-0">
                    <h5 class="mt-0">Meios de transmissao da <?php echo $data->nome  ?></h5>
                    <p><?php echo $data->conteudo_trans ?></p>
                </div>
            </div>
        </div>
    </header>
